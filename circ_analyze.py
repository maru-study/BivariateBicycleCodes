...
import numpy as np
# load result file
fname = './TMP/mydata_144_12_p_0.003_cycles_12'
with open(fname, 'rb') as fp:
	mydata = pickle.load(fp)

# print result
print(mydata['HdecX'].todense().shape)
print(mydata['HdecZ'].todense().shape)
print(mydata['HX'].todense().shape)
print(mydata['HZ'].todense().shape)
